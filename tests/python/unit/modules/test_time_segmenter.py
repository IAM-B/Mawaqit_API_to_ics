...
from app.modules.time_segmenter import generate_empty_slots, segment_available_time
...
def test_segment_available_time_with_padding():
    ...
    prayer_times = {"fajr": "08:00", "dohr": "09:00", "asr": "10:00"}
...
def test_segment_available_time_different_timezone():
    ...
    prayer_times = {"fajr": "05:00", "dohr": "13:00", "asr": "16:00"}
    segments = segment_available_time(prayer_times, "Europe/Paris", 0, 0)
    assert len(segments) == 2
...
def test_segment_available_time_close_prayers():
    ...
    prayer_times = {"fajr": "08:00", "dohr": "08:05", "asr": "08:10"}
