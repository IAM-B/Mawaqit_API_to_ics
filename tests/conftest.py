...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "python: marque les tests Python")
    config.addinivalue_line("markers", "javascript: marque les tests JavaScript")
    config.addinivalue_line("markers", "e2e: marque les tests end-to-end")
